...
router.post("/add-and-update-about-content", authenticate, upload.single("aboutImage"), aboutController.addUpdateAboutContent);
...
router.put("/update-about-content/:id", authenticate, upload.single("aboutImage"), aboutController.updateAboutContent);
